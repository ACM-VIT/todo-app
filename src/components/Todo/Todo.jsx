...
export default function Todo({ todo }) {
  ...
  return (
    <ListItem className={todo.complete ? "check" : ""}>
      ...
      <ListItemSecondaryAction>
        <IconButton onClick={del.bind(null, todo.id)} aria-label="comments">
          <DeleteIcon />
        </IconButton>
        <IconButton onClick={upd.bind(null, todo.id)} aria-label="comments">
          <EditIcon />
        </IconButton>
      </ListItemSecondaryAction>
    </ListItem>
